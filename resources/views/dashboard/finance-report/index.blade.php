    ...
    <div class="table-responsive text-nowrap">
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    <td colspan="4" style="background-color: #d3d3d3" class="text-right fw-bold">Periode: {{ $month }}
                    </td>
                </tr>
                ...
                <tr class="bg-" style="background-color:#dbe5d8">
                    ...
                    <td colspan="1" class="text-end"><b>Rp {{ number_format($data['sales'], 0, ',', '.') }}</b></td>
                </tr>
                <tr class="bg-" style="background-color:#d8e4e5">
                    <td colspan="2" class="text-end fw-bold">Total Pembelian:</td>
                    <td colspan="1" class="text-end"><b>Rp {{ number_format($data['purchases'], 0, ',', '.') }}</b></td>
                </tr>
                <tr class="{{ $data['profit'] < 0 ? 'bg-danger text-white' : '' }}"
                    style="background-color: {{ $data['profit'] >= 0 ? '#aef1a8' : '#ff6961' }}">
                    <td colspan="2" class="text-end fw-bold">Profit:</td>
                    <td colspan="1" class="text-end"><b>Rp {{ number_format($data['profit'], 0, ',', '.') }}</b></td>
                </tr>
                @endforeach
            </tbody>
