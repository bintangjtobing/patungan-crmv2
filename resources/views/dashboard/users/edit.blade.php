...
<div class="card mb-4">
    <h5 class="card-header">Edit User Profile Details</h5>
    <div class="card-body">
        <form action="{{ route('users.update', $user->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="d-flex align-items-start align-items-sm-center gap-4 mb-4">
                <img src="{{ $user->profile_picture ?? asset('default-avatar.png') }}" alt="user-avatar"
            ...
            <div class="row">
                ...
                <div class="mb-3 col-md-6">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="type" id="type_user" value="0" {{ $user->type
                        == 0 ? 'checked' : '' }}>
