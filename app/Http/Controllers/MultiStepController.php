    ...
    public function submitForm(Request $request)
        {
            ...
            if ($request->customer_type === 'new') {
                ...
                $description = "Member baru dengan penjualan \"{$request->product_uuid}\" untuk bulan " . 
                ...
                // Description for existing customer
                $description = "Perpanjangan member dengan penjualan \"{$request->product_uuid}\" untuk bulan " . 
                    now()->translatedFormat('F') . 
                    " hingga bulan " . 
                    now()->addMonths($request->jumlah)->translatedFormat('F');
            }
